...
# I have created three .csv files for you on GitHub for three different primate species. These are called AHData_InVivoROM_Papio.csv, AHData_InVivoROM_Pan.csv, and AHData_InVivoROM_Macaca.csv . Please use the .csv file that you have been assigned.
# Remeber, to import a .csv file into R, we use the function read.csv() .
...
# Calculate the ranges for 4 of the variables in rom.dat. Make sure to write down both your code and the answers below:
# For example:
